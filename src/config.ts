...
export const themeConfig: ThemeConfig = {
  ...
  global: {
    ...
    moreLocales: ['zh', 'zh-tw', 'ja', 'es'], // ['zh', 'zh-tw', 'ja', 'en', 'es', 'ru', 'pt']
  ...
  seo: {
    ...
    umamiAnalyticsID: 'f5049552-405b-488c-b2eb-ece7f6ce22fd',
    // follow verification
    // https://follow.is/
    follow: {
      // feed ID
  ...
  preload: {
    ...
    customUmamiAnalyticsJS: 'https://iumami.netlify.app/script.js',
  },
